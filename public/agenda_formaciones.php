<?php
// agenda_formaciones.php – Agenda del CEO
// --------------------------------------------------------------
// Adaptada para usar el mismo HEADER, estructura y estilos
// que formaciones.php (Bootstrap + topbar + cards).
// --------------------------------------------------------------
...
INNER JOIN ceo_formacion cs ON p.id_cuadrilla = cs.cuadrilla
INNER JOIN ceo_formacion_servicios sp ON cs.id_servicio = sp.id
...
/* ========================================================
   2) SERVICIOS
   ======================================================== */
$sqlServ = "SELECT id, servicio, descripcion FROM ceo_formacion_servicios ORDER BY servicio";
...
<head>
<meta charset="utf-8">
<title>Formaciones - Agenda - <?= esc(APP_NAME) ?></title>
...
<!-- ============================================================
     HEADER (COPIADO DE formaciones.php)
============================================================ -->
        ...
        <div class="row">
          ...
          <div class="col-md-6 border-start">
            ...
            <div class="alert alert-info p-2 small">
              Formato esperado (Hoja Formaciones):<br>
...
document.getElementById("btnGuardarModal").addEventListener("click", () => {
    ...
    // 🔹 Enviar
    fetch("../public/grabar_formacion.php", {
        method: "POST",
        body: form
    })
    .then(async r => {
