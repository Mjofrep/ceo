            ...
            try {
                ...
                if (!$usr) {
                    ...
                    if (!$pruebas) {
                        ...
                        // ✔ SOLICITUD (CORREGIDO)
                        //$sql = "SELECT a.*, b.id_servicio FROM ceo_solicitudes a INNER JOIN ceo_habilitacion b ON a.nsolicitud = b.nsolicitud WHERE a.nsolicitud = :id";
                        //$stmt = $pdo->prepare($sql);
...
<head>
<meta charset="utf-8">
<title>Ingreso Evaluador Teórica | <?= APP_NAME ?></title>
