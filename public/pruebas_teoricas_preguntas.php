<?php
// --------------------------------------------------------------
// pruebas_teoricas_preguntas.php - Centro de Excelencia Operacional (CEO)
...
// =================== CONTADOR Y LISTADO ===================
$contPreg = $pdo->prepare("SELECT COUNT(*) FROM ceo_preguntas_servicios WHERE id_agrupacion = :id");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  try {
    ...
    $stmt = $pdo->prepare("INSERT INTO ceo_preguntas_servicios 
    ...
    if ($tipoPregunta === 'VF') {
      ...
      for ($i = 1; $i <= 2; $i++) {
        ...
        $stmtAlt = $pdo->prepare("INSERT INTO ceo_alternativas_preguntas
...
<head>
<meta charset="utf-8">
<title>Banco de Preguntas | <?= htmlspecialchars(APP_NAME) ?></title>
...
<header class="topbar py-3 mb-4">
  <div class="container d-flex align-items-center justify-content-between">
    ...
    <a href="pruebas_teoricas.php" class="btn btn-outline-primary btn-sm">← Volver</a>
  </div>
</header>
...
<div class="container mb-5">
  ...
  <div class="card rounded-4 mb-4">
    <div class="card-body d-flex justify-content-between align-items-center">
      <div>
        <h6 class="text-primary mb-2"><i class="bi bi-journal-text me-2"></i>Agregar al Banco de Preguntas</h6>
