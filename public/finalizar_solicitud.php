...
<head>
<meta charset="utf-8">
<title>Finalizar Solicitud #<?= htmlspecialchars((string)($sol['nsolicitud'] ?? '—')) ?> - <?= htmlspecialchars((string)APP_NAME) ?></title>
...
<div class="container mb-5">
  <h5 class="text-primary mb-3">
    ...
    Finalizar Solicitud N° <?= htmlspecialchars((string)($sol['nsolicitud'] ?? '')) ?>
  </h5>
...
document.getElementById('btnFinalizar').addEventListener('click', async ()=>{
  ...
  try{
    const resp = await fetch('finalizar_solicitud_update.php',{method:'POST',body:fd});
